...
import Store from "@/hook/useCutVideo/store";
import { inject, ref, onMounted, computed, watchEffect } from "vue";
import Grid from "./Grid.vue";
import VideoItem from "./VideoItem.vue";
import Mapping from "@/hook/useCutVideo//map";
import { TimeLine } from "@/hook/useCutVideo/viewmodels";
import { useCutVideo } from "@/hook/useCutVideo/index";
// 核心数据
...
const {initParams}=useCutVideo();
let url="https://tradeplus.oss-cn-hangzhou.aliyuncs.com/files/649baad98b415c6fd0c5dd27.mp4"
