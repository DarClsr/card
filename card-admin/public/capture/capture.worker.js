...
/* harmony import */ var core_js_modules_es_typed_array_uint8_clamped_array_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9743);
/* harmony import */ var core_js_modules_es_typed_array_uint8_clamped_array_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_typed_array_uint8_clamped_array_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var core_js_modules_es_typed_array_fill_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3105);
...
/* harmony import */ var core_js_modules_es_typed_array_iterator_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6319);
/* harmony import */ var core_js_modules_es_typed_array_iterator_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_typed_array_iterator_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var core_js_modules_es_typed_array_set_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3462);
...
/* harmony import */ var core_js_modules_es_typed_array_sort_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3824);
...
/* harmony import */ var core_js_modules_es_typed_array_to_string_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(5016);
/* harmony import */ var core_js_modules_es_typed_array_to_string_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_typed_array_to_string_js__WEBPACK_IMPORTED_MODULE_7__);
...
/* harmony import */ var core_js_modules_es_object_get_own_property_descriptors_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(9337);
...
/* harmony import */ var core_js_modules_es_symbol_async_iterator_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(2443);
...
/* harmony import */ var core_js_modules_es_json_to_string_tag_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(3706);
...
/* harmony import */ var core_js_modules_es_math_to_string_tag_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(2703);
...
class ImageCapture {
  ...
  getImageInfo(imgDataPtr) {
    var width = Module.HEAPU32[imgDataPtr];
    var height = Module.HEAPU32[imgDataPtr + 1];
    var duration = Module.HEAPU32[imgDataPtr + 2];
    var imageBufferPtr = Module.HEAPU32[imgDataPtr + 3];
    var imageBuffer = Module.HEAPU8.slice(imageBufferPtr, imageBufferPtr + width * height * 3);
    ...
    var imageDataBuffer = new Uint8ClampedArray(width * height * 4);
    var j = 0;
  ...
  capture(_ref) {
    var id = _ref.id,
      ...
      file = _ref.file;
    try {
      var name = this.mountFile(file, path, id);
      var retData = 0;
      this.imageList[id] = [];
...
function transpostFrame(ptr, id) {
  var data = imageCapture.getImageInfo(ptr / 4);
  // push到数组列表
  imageCapture.imageList[id].push(_objectSpread({}, data));
  self.postMessage(_objectSpread(_objectSpread({
...
var initPromise = new Promise(res => {
  self.goOnInit = res;
});
...
self.Module = {
  instantiateWasm: function () {
    var _instantiateWasm = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(info, receiveInstance) {
      var url;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            url = _context.sent;
            fetch(url || './capture.worker.wasm').then(response => response.arrayBuffer()).then(bytes => WebAssembly.instantiate(bytes, info)).then(instance => receiveInstance(instance.instance));
