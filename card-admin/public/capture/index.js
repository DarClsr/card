(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["cheetahCapture"] = factory();
	else
		root["cheetahCapture"] = factory();
})(self, function() {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  initCapture: function() { return /* binding */ initCapture; }
});
...
function _initWorker() {
  _initWorker = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url, wasmPath) {
    var promise;
        ...
        case 2:
          ...
          promise = new Promise(resolve => {
            captureWorker && captureWorker.addEventListener('message', e => {
              var _e$data;
              if ((e === null || e === void 0 ? void 0 : (_e$data = e.data) === null || _e$data === void 0 ? void 0 : _e$data.type) === 'init') {
                // wasm初始化完毕
...
function createRequest() {
  ...
  return {
    ...
    setFrameCallback(item) {
      var id = ++currentId;
      map.set(currentId, _objectSpread(_objectSpread({}, item), {}, {
        url: []
      }));
      return id;
    },
...
var pool = createRequest();
var canvas = document.createElement('canvas');
var ctx = canvas.getContext('2d');
function rotateImage(imageData) {
  var direction = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'l';
  var H = imageData.height;
  var W = imageData.width;
  var imgDt1 = new ImageData(H, W);
  var imgDt2 = new ImageData(H, W);
  var dt0 = imageData.data;
  var dt1 = imgDt1.data;
  var dt2 = imgDt2.data;

  // 2. Transposex
  var r = 0;
  var r1 = 0; // index of red pixel in old and new ImageData, respectively
  for (var y = 0, lenH = H; y < lenH; y++) {
    for (var x = 0, lenW = W; x < lenW; x++) {
      r = (x + lenW * y) * 4;
      r1 = (y + lenH * x) * 4;
      dt1[r1 + 0] = dt0[r + 0];
      dt1[r1 + 1] = dt0[r + 1];
  ...
  for (var _y = 0, _lenH = W; _y < _lenH; _y++) {
    for (var _x3 = 0, _lenW = H; _x3 < _lenW; _x3++) {
      r = (_x3 + _lenW * _y) * 4;
      r1 = direction === 'l' ? (_x3 + _lenW * (_lenH - 1 - _y)) * 4 : (_lenW - 1 - _x3 + _lenW * _y) * 4;
      dt2[r1 + 0] = dt1[r + 0];
      dt2[r1 + 1] = dt1[r + 1];
      dt2[r1 + 2] = dt1[r + 2];
      dt2[r1 + 3] = dt1[r + 3];
...
function getUrl(_x4, _x5, _x6, _x7) {
  return _getUrl.apply(this, arguments);
}
function _getUrl() {
  _getUrl = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(width, height, imageDataBuffer, angle) {
...
function capture(data) {
  ...
  var id = pool.setFrameCallback(func);
  startCapture(id, info, path, file);
}
function initCapture(_x8) {
  return _initCapture.apply(this, arguments);
}
function _initCapture() {
  _initCapture = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(_ref) {
        ...
        case 3:
          ...
          worker.addEventListener('message', /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
              var _e$data2;
              var _ref3, imageDataBuffer, width, height, duration, id, _ref3$meta, meta, _meta$angle, angle, img, cbk, onChange, _info, _pool$getCbk, url, _ref4, _id, _meta, _cbk, onSuccess, _pool$getCbk2, _url, _ref5, errmsg, _id2, _cbk2, onError;
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.t0 = e === null || e === void 0 ? void 0 : (_e$data2 = e.data) === null || _e$data2 === void 0 ? void 0 : _e$data2.type;
                    _context3.next = _context3.t0 === Events.receiveImageOnchange ? 3 : _context3.t0 === Events.receiveImageOnSuccess ? 15 : _context3.t0 === Events.receiveError ? 21 : 26;
                    break;
                  case 3:
                    _ref3 = e.data || {}, imageDataBuffer = _ref3.imageDataBuffer, width = _ref3.width, height = _ref3.height, duration = _ref3.duration, id = _ref3.id, _ref3$meta = _ref3.meta, meta = _ref3$meta === void 0 ? {} : _ref3$meta;
                  ...
                  case 15:
                    _ref4 = e.data || {}, _id = _ref4.id, _meta = _ref4.meta;
                    _cbk = pool.getCbk(_id);
                    onSuccess = _cbk.onSuccess;
                    _pool$getCbk2 = pool.getCbk(_id), _url = _pool$getCbk2.url;
                    onSuccess && onSuccess({
                      url: _url,
                      meta: _meta
                    });
                    return _context3.abrupt("break", 27);
                  case 21:
                    _ref5 = e.data || {}, errmsg = _ref5.errmsg, _id2 = _ref5.id;
                    _cbk2 = pool.getCbk(_id2);
                    onError = _cbk2.onError;
